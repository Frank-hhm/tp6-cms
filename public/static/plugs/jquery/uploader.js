/*
* @Author: 小明
* @Date:   2020-01-02 11:02:04
* @Last Modified by:   根子科技
* @Last Modified time: 2020-01-02 11:16:29
*/
define(function () {
    return function (element, InitHandler, UploadedHandler, CompleteHandler) {
        ...
        // // 检查可以上传的文件后缀
        // $.form.load(window.ROOT_URL + "/api/plugs/check", {exts: exts, uptype: uptype}, 'post', function (ret, options) {
